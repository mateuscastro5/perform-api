...
export class InitialSchema1760909740767 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."permissions_type_enum" AS ENUM('view_dashboard', 'view_individual_metrics', 'view_squad_metrics', 'compare_performance', 'export_reports', 'manage_permissions', 'manage_users', 'manage_squads', 'view_ai_recommendations')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('admin', 'tech_lead', 'developer')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."reports_type_enum" AS ENUM('developer_performance', 'squad_performance', 'pr_analysis', 'custom')`);
        await queryRunner.query(`CREATE TYPE "public"."reports_format_enum" AS ENUM('pdf', 'csv', 'json')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."ai_recommendations_category_enum" AS ENUM('productivity', 'code_quality', 'collaboration', 'learning', 'performance')`);
        await queryRunner.query(`CREATE TYPE "public"."ai_recommendations_priority_enum" AS ENUM('low', 'medium', 'high')`);
        ...
        await queryRunner.query(`ALTER TABLE "code_reviews" ADD CONSTRAINT "FK_3b42ffcce19bfdb40ee3026cf11" FOREIGN KEY ("reviewerId") REFERENCES "developers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "code_reviews" ADD CONSTRAINT "FK_fc180b01ff515eb65a43bf6784d" FOREIGN KEY ("pullRequestId") REFERENCES "pull_requests"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "commits" ADD CONSTRAINT "FK_95770d13d237bc9ca1bf6ad5adb" FOREIGN KEY ("authorId") REFERENCES "developers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "commits" ADD CONSTRAINT "FK_f7a02eaf4e1d4985564e5898849" FOREIGN KEY ("pullRequestId") REFERENCES "pull_requests"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "pull_requests" ADD CONSTRAINT "FK_a3d5bcd80f585c20fb9a709c555" FOREIGN KEY ("authorId") REFERENCES "developers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "metrics" ADD CONSTRAINT "FK_c354440a8a7d02c1c4ac1fe1aa7" FOREIGN KEY ("developerId") REFERENCES "developers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "developers" ADD CONSTRAINT "FK_ee5352c86dc04163034a8f6a405" FOREIGN KEY ("squadId") REFERENCES "squads"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "squads" ADD CONSTRAINT "FK_8c412375c1e25d20da950503f10" FOREIGN KEY ("techLeadId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_0216e641f1d5f037ccafc81af9d" FOREIGN KEY ("squadId") REFERENCES "squads"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "ai_recommendations" ADD CONSTRAINT "FK_23eede31766f1ff75855d0c9c1e" FOREIGN KEY ("developerId") REFERENCES "developers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ai_recommendations" DROP CONSTRAINT "FK_23eede31766f1ff75855d0c9c1e"`);
        await queryRunner.query(`ALTER TABLE "reports" DROP CONSTRAINT "FK_d3d65c7e12b3c642405fd1fbdc6"`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_0216e641f1d5f037ccafc81af9d"`);
        await queryRunner.query(`ALTER TABLE "squads" DROP CONSTRAINT "FK_8c412375c1e25d20da950503f10"`);
        await queryRunner.query(`ALTER TABLE "developers" DROP CONSTRAINT "FK_ee5352c86dc04163034a8f6a405"`);
        await queryRunner.query(`ALTER TABLE "metrics" DROP CONSTRAINT "FK_c354440a8a7d02c1c4ac1fe1aa7"`);
        await queryRunner.query(`ALTER TABLE "pull_requests" DROP CONSTRAINT "FK_a3d5bcd80f585c20fb9a709c555"`);
        await queryRunner.query(`ALTER TABLE "commits" DROP CONSTRAINT "FK_f7a02eaf4e1d4985564e5898849"`);
        await queryRunner.query(`ALTER TABLE "commits" DROP CONSTRAINT "FK_95770d13d237bc9ca1bf6ad5adb"`);
        await queryRunner.query(`ALTER TABLE "code_reviews" DROP CONSTRAINT "FK_fc180b01ff515eb65a43bf6784d"`);
        await queryRunner.query(`ALTER TABLE "code_reviews" DROP CONSTRAINT "FK_3b42ffcce19bfdb40ee3026cf11"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."ai_recommendations_priority_enum"`);
        await queryRunner.query(`DROP TYPE "public"."ai_recommendations_category_enum"`);
